...
object_t *
get_environment (environment_t *environment, char *key)
{
    generic_key_value_t *key_value
        = (generic_key_value_t *)get_value_hash_table (environment->store,
                                                       key);
...
object_t *
set_environment (environment_t *environment, char *key, object_t *value)
{
